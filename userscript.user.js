...
// @version      0.1
// @description  Holt die Reinlads vom 1. April 2019 nicht nur jeden Samstag zurück
// @author       erdbaer
...
function loadC0mmunityPaint() {
  fetch('https://erdbeere.github.io/reinlad/c0mmunity-paint.js')
    .then(r => r.text())
    .then(eval)
}
...
p.View.Paint = p.View.Base.extend({
  ...
  tools: {
    ...
    brush: {
      path: 'https://erdbeere.github.io/reinlad/media/paint/brush.png',
      width: 57,
      height: 57,
      alpha: 0.2,
      size: 1
    ...
    spray: {
      path: 'https://erdbeere.github.io/reinlad/media/paint/spray.png',
      width: 75,
      height: 75,
      alpha: 0.05,
      size: 1.5
  ...
  render: function() {
    ...
    this.$container.find('.paint-new').click(
      function(ev) {
    ...
    this.$container.find('.paint-color-button').click(
      function(ev) {
    ...
    this.$container.find('.paint-tool').click(
      function(ev) {
    ...
    this.$container.find('.paint-size').click(
      function(ev) {
    ...
    this.$container.find('.paint-undo').click(
      function(ev) {
        this.historyUndo()
      }.bind(this)
    )
    this.$container.find('.paint-redo').click(
      function(ev) {
        this.historyRedo()
      }.bind(this)
    )
    this.$container.find('.paint-animation-frame-add').click(
      function(ev) {
        this.frameAdd()
        this.frameSetCurrent(this.animationFrameIndex + 1)
      }.bind(this)
    )
    this.$container.find('.paint-animation-frame-duplicate').click(
      function(ev) {
        this.frameDuplicate()
        this.frameSetCurrent(this.animationFrameIndex + 1)
      }.bind(this)
    )
    this.$container.find('.paint-animation-frame-remove').click(
      function(ev) {
    ...
    this.$container.find('.paint-animation-frame-move-left').click(
      function(ev) {
        this.frameMoveLeft()
      }.bind(this)
    )
    this.$container.find('.paint-animation-frame-move-right').click(
      function(ev) {
        this.frameMoveRight()
      }.bind(this)
    )
    this.$container.find('.paint-animation-toggle-preview').click(
      function(ev) {
        this.animationTogglePreview()
      }.bind(this)
    )
    this.$container.find('.paint-duration').on(
      'change input',
      function(ev) {
  ...
  animationGenerateGIF: function(callback) {
    if (this.gifJsLoaded) {
      ...
      $.getScript(
        'https://erdbeere.github.io/reinlad/media/paint/gif.js',
        function() {
  ...
  animationGenerateGIFNow: function(callback) {
    $.get('https://erdbeere.github.io/reinlad/media/paint/gif.worker.js', workerScript => {
...
var reinladSVG = $(
  '<svg style="width: 16px; height: 16px;vertical-align: middle; margin-top: -2px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M497.9 142.1l-46.1 46.1c-4.7 4.7-12.3 4.7-17 0l-111-111c-4.7-4.7-4.7-12.3 0-17l46.1-46.1c18.7-18.7 49.1-18.7 67.9 0l60.1 60.1c18.8 18.7 18.8 49.1 0 67.9zM284.2 99.8L21.6 362.4.4 483.9c-2.9 16.4 11.4 30.6 27.8 27.8l121.5-21.3 262.6-262.6c4.7-4.7 4.7-12.3 0-17l-111-111c-4.8-4.7-12.4-4.7-17.1 0zM124.1 339.9c-5.5-5.5-5.5-14.3 0-19.8l154-154c5.5-5.5 14.3-5.5 19.8 0s5.5 14.3 0 19.8l-154 154c-5.5 5.5-14.3 5.5-19.8 0zM88 424h48v36.3l-64.5 11.3-31.1-31.1L51.7 376H88v48z"></path></svg>'
)

uploadLink.attr('href', '/paint')
uploadLink.attr('title', 'Reinlad erstellen')
